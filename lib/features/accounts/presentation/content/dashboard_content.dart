...
import '../widgets/dashboard/accounts_kpi_widget.dart';
import '../widgets/dashboard/aged_debtors_widget.dart';
import '../widgets/dashboard/quick_actions_widget.dart';
import '../widgets/dashboard/revenue_charts_widget.dart';
...
class DashboardContent extends ConsumerWidget {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // KPI Metrics
          const AccountsKPIWidget(),
          const SizedBox(height: 24),

          // Charts Section
          const RevenueChartsWidget(),
          const SizedBox(height: 24),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Here\'s your revenue overview for today',
                  style: TextStyle(
                    color: Colors.white.withOpacity(0.95),
                    fontSize: 16,
                    fontWeight: FontWeight.w500,
                ...
                Wrap(
                  ...
                  runSpacing: 8,
                  children: [
                    _buildStatChip('Today\'s Collection: KES 245,680', Icons.trending_up),
                    _buildStatChip('Pending Invoices: 42', Icons.pending_actions,
                        onTap: () => onNavigate('/accounts/controller')),
                    _buildStatChip('Overdue Accounts: 18', Icons.warning,
                        onTap: () => onNavigate('/accounts/collections')),
                  ],
                ),
              ],
            ),
  ...
  // ... rest of your existing methods (_buildStatChip, _buildRecentActivity, _buildActivityItem) remain the same
    ...
    final activities = [
      {
        ...
        'description': 'KES 45,200 from Industrial Zone',
        'time': '10:30 AM',
        'icon': Icons.payment,
        'color': Colors.green,
      ...
      },
      {
        ...
        'description': 'Generated 1,245 invoices for February',
        'time': '9:15 AM',
        'icon': Icons.receipt,
        'color': Colors.blue,
      ...
      {
        'type': 'alert',
        'title': 'High Debt Account',
        'description': 'Account #789012 overdue by 45 days',
        'time': 'Yesterday',
        'icon': Icons.warning,
        'color': Colors.orange,
      ...
      },
      {
        ...
        'description': 'February revenue report ready for review',
        'time': '8:45 AM',
          ...
          children: [
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () => onNavigate('/accounts/reports'),
